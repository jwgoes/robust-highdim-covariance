%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script exploring use of Tyler's M-estimator in outlier settings
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for counter = 1:iter
    ...
    for j=1:n_epsilon
        ...
        figure(55); plot(new_weights,'rs-'); grid on; title('NEW WEIGHTS'); drawnow; 
    ...
    if mod(counter,2)==0
 %%       
        figure(41); clf; set(gca,'fontsize',20); 
